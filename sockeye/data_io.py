...
#TODO: @gaurav
def get_style_training_data_iters(source: str, target: str,
                                  vocab_source: Dict[str, int], vocab_target: Dict[str, int],
                                  batch_size: int,
                                  fill_up: str,
                                  max_seq_len: int,
    ...
    :param source: Path to source training data.
    :param target: Path to target training data.
    :param validation_source: PathV to source validation data.
    :param validation_target: Path to target validation data.
    :param vocab_source: Source vocabulary.
    :param vocab_target: Target vocabulary.
    :param batch_size: Batch size.
...
class MonoSentenceIter(mx.io.DataIter):
    """
    A Bucket sentence iterator for monolingual data.
